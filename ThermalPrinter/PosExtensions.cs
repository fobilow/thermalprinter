...
namespace ReceiptPrinter
{
    public static class PosExt
    {
        ...
        public static void Start(this BinaryWriter bw)
        {
            bw.LargeText("Vogue Hotel");
            bw.NormalFont("No 60. Old Karu Road,");
            bw.NormalFont("Mararaba, Nasarawa State.");
            bw.NormalFont("Tel:081 3566 6789");
        ...
        {
            bw.FeedLines(2);
            bw.NormalFont("Thanks for your payment");

            bw.FeedLines(2);
            bw.NormalFont("PLEASE KEEP THIS RECEIPT");
            bw.NormalFont("FOR YOUR RECORDS");
            bw.FeedLines(1);
            bw.Write(AsciiControlChars.Newline);
        }
